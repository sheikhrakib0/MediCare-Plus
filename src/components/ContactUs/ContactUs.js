        ...
        <div className="container mx-auto my-4 px-4 lg:px-20">
          ...
          <div
            ...
            <div className="flex flex-col text-white">
              ...
              <p className="text-gray-400">We are here to serve the best treatement for the patients. We have modern technology for better service.
              </p>
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">Address: 1148 Williams Avenue, Brooklyn, NewYork, USA</p>
                </div>
              </div>
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">Tel: +1104378489</p>
                  <p className="text-gray-400">Fax: johnkarim@gmail.com</p>
                </div>
              </div>
